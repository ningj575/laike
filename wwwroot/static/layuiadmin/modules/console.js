  ...
  */
  ...
  layui.use('table', function(){
    ...
    table.render({
      ...
      ,url: 'https://demo.layuion.com/layuiAdmin/layuiAdmin-v2.7.1/iframe/res/json/console/top-search.js' //模拟接口
      ,page: true
      ,cols: [[
    ...
    table.render({
      ...
      ,url: 'https://demo.layuion.com/layuiAdmin/layuiAdmin-v2.7.1/iframe/res/json/console/top-card.js' //模拟接口
      ,page: true
      ,cellMinWidth: 120
      ,cols: [[
        {type: 'numbers', fixed: 'left'}
    ...
    table.render({
      ...
      ,url: 'https://demo.layuion.com/layuiAdmin/layuiAdmin-v2.7.1/iframe/res/json/console/prograss.js' //模拟接口
      ,cols: [[
