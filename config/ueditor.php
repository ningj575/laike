...
return[
    ...
    "imageUrlPrefix" => config('public.sites.static'), /* 图片访问路径前缀 */
    ...
    "scrawlUrlPrefix" => config('public.sites.static'), /* 图片访问路径前缀 */
    "scrawlInsertAlign" => "none",
    /* 截图工具上传 */
    "snapscreenActionName" => "uploadimage", /* 执行上传截图的action名称 */
    "snapscreenPathFormat" => "/uploads/ueditor/image/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    "snapscreenUrlPrefix" => config('public.sites.static'), /* 图片访问路径前缀 */
    ...
    "catcherUrlPrefix" => config('public.sites.static'), /* 图片访问路径前缀 */
    ...
    "videoUrlPrefix" => config('public.sites.static'), /* 视频访问路径前缀 */
    ...
    "fileUrlPrefix" => config('public.sites.static'), /* 文件访问路径前缀 */
    ...
    "imageManagerUrlPrefix" => config('public.sites.static'), /* 图片访问路径前缀 */
    ...
    "fileManagerUrlPrefix" => config('public.sites.static'), /* 文件访问路径前缀 */
